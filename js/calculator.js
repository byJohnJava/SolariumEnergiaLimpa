function calculoPainel()
{
    ...
    if (inversor<=2.03) {Pmedio="R$ 15.818,78"}         
    else if (inversor>2.03&&inversor<=2.43) {Pmedio="16.800,00"}
    else if (inversor>2.44&&inversor<=3.65) {Pmedio="22.380,00"}
    else if (inversor>3.66&&inversor<=4.46) {Pmedio="26.130,00"}
    else if (inversor>4.47&&inversor<=4.86) {Pmedio="27.750,00"}
    else if (inversor>4.87&&inversor<=5.27) {Pmedio="29.580,00"}
    else if (inversor>5.28&&inversor<=6.48) {Pmedio="34.230,00"}
    else if (inversor>6.49&&inversor<=6.89) {Pmedio="35.870,00"}
    else if (inversor>6.90&&inversor<=7.70) {Pmedio="39.930,00"}
    else if (inversor>7.71&&inversor<=8.91) {Pmedio="44.140,00"}
    else if (inversor>8.92&&inversor<=9.72) {Pmedio="47.150,00"}
    else if (inversor>9.73&&inversor<=11.34) {Pmedio="51.440,00"}
    else if (inversor>11.35&&inversor<=12.56) {Pmedio="57.310,00"}
    else if (inversor>12.57&&inversor<=14.58) {Pmedio="67.100,00"}
    else if (inversor>14.59&&inversor<=21.06) {Pmedio="92.100,00"}
